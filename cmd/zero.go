...
func Substract(from string, substract string) (result string) {
	...
	num2, err := strconv.ParseFloat(substract, 64)
	if err != nil {
		fmt.Println("Error: first value is invalid")
		return
	}
...
func Divide(divide string, by string, shouldRoundUp bool) (result string, err error) {
